var PolyglotInternal = require('../build/Release/polyglot').Polyglot;
var Chess = require('chess.js').Chess;

var Polyglot = function(bookFile) {
    var pieceTypes = {
        bp: 0,
        wp: 1,
        bn: 2,
    ...
    this.polyglotInternal = new PolyglotInternal(bookFile);
    Polyglot.prototype.find_best = function(fen) {
        var self = this;
        var game = new Chess(fen);
        return self.polyglotInternal.find_best(fen);
    };

    Polyglot.prototype.find_first = function(fen) {
        var self = this;
        return self.polyglotInternal.find_first(fen);
    };
